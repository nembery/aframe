...
urlpatterns = patterns('',
                       ...
                       url(r'^preview/(?P<input_form_id>[^/]+)/$', views.preview, name='preview'),
                       ...
                       url(r'^apply$', views.apply_template, name='apply_template'),
                       url(r'^applyToQueue', views.apply_template_to_queue, name='apply_template_to_queue'),
                       url(r'^applyStandalone$', views.apply_standalone_template, name='apply_standalone_template'),
                       url(r'^edit/(?P<input_form_id>[^/]+)/$', views.edit, name='edit'),
                       url(r'^delete/(?P<input_form_id>[^/]+)/$', views.delete, name='delete'),
